...
def create_document_structure(document, structure, user_input):
    for section, subsections in structure.items():
        ...
        if subsections:  # If there are subsections
            for subsection in subsections:
                ...
                content = generate_text_for_section(subsection, user_input)
                document.add_paragraph(content)
        else:  # If no subsections, generate for the main section
            content = generate_text_for_section(section, user_input)
            document.add_paragraph(content)
...
openai.api_key = 'INSER API KEY HERE'
...
if user_input:
    ...
    create_document_structure(doc, document_structure, user_input)
